    ...
    <div class="isian">
        <div class="container">
            ...
            <div class="isianinput">
                ...
                @endforeach
                @foreach($user_civitas_fasilitas as $user_civitas)
                <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                        <div class="d-flex w-100 justify-content-between">
                            <h4>Civitas</h4>
                ...
                @endforeach
                @foreach($user_masyarakat_fasilitas as $user_masyarakat)
                <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                        <div class="d-flex w-100 justify-content-between">
                            <h4>Masyarakat</h4>
