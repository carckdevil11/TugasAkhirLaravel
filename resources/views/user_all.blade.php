            ...
            <div class="isianinput">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 text-center">
                        ...
                        <h2>* Bagian kamu : Admin Full Control</h2>
                        <h2>* Status Login : {{Session::get('login')}}</h2>
                        <a href="/logout" class="btn btn-primary btn-lg">Logout</a>
                        <a href="{{url('register')}}" class="btn btn-primary btn-warning">Register User</a>
                    </div>
                </div>
                <br>
                @foreach($user_mahasiswa as $user_mahasiswa)
                ...
                @endforeach
                @foreach($user_civitas as $user_civitas)
                <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                        <div class="d-flex w-100 justify-content-between">
                            <h4>Civitas</h4>
                ...
                @endforeach
                @foreach($user_masyarakat as $user_masyarakat)
                <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-action flex-column align-items-start">
                        <div class="d-flex w-100 justify-content-between">
                            <h4>Masyarakat</h4>
